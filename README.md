...
This is the solution for the MyReads project for Udacity's React Fundamentals course. I customized pre-installed template to implement the requirements.
